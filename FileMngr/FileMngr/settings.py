"""
Django settings for FileMngr project.
...
#initialize environment variables form .env file:
env = environ.Env()
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-&8w7+x)x4@&r6%i(9!at&px#^6_zvly$7@0qouj-*y7-jtuwmh'
...
WSGI_APPLICATION = 'FileMngr.wsgi.application'
